export class AnswerEvaluator {
    // 💡 建立 OpenCC 轉換器快取（單例模式，確保只初始化一次以節省效能）
    static _converter = null;

    /**
     * 呼叫外部 OpenCC 庫將簡體字轉為繁體字
     */
    static convertToTraditional(text) {
        if (!text) return "";
        
        // 若尚未建立轉換器，且外部的 OpenCC 已成功載入
        if (!this._converter) {
            if (typeof OpenCC !== 'undefined') {
                this._converter = OpenCC.Converter({ from: 'cn', to: 'tw' });
            } else {
                // 若 CDN 載入失敗或無網路，作為保護機制，直接回傳原字串
                return text; 
            }
        }
        return this._converter(text);
    }
    ...
    static normalizeSTTText(text) {
        ...
        const sttCorrectionMap = {
            ...
            "時事": "實事", "史事": "實事", "石事": "實事", "實是": "實事", "十事": "實事", "44": "實事", "14": "實事",
            "務質": "物質", "物資": "物質", "霧質": "物質",
            "心事": "心識", "心視": "心識", "新識": "心識", "心適": "心識", "新市": "心識", "心室": "心識", "新式": "心識",
            "長法": "常法", "場法": "常法", "唱法": "常法", "長髮": "常法",
            "吾我": "無我", "無窩": "無我", "五我": "無我",
            "兔子腳": "兔子角", "兔仔角": "兔子角", "兔角": "兔子角",
            "所爭事": "所諍事", "所正事": "所諍事", "鎖諍事": "所諍事", "鎖證事": "所諍事", "所診事": "所諍事", "鎖針式": "所諍事",
            "所現法": "所顯法", "所線法": "所顯法", "鎖顯法": "所顯法",
            "程式": "承許", "成許": "承許", "誠許": "承許", "陳許": "承許", "呈許": "承許",
            "合一顧": "何以故", "可以顧": "何以故", "合以顧": "何以故", "何以顧": "何以故", "合一故": "何以故", "可以故": "何以故", "合衣顧": "何以故", "和以故": "何以故",

            // 二、 格式用語與關係用語
            "照片": "周遍", "周變": "周遍", "舟遍": "周遍", "州遍": "周遍", "週遍": "周遍",
            "無法按立": "無法安立", "無法昂立": "無法安立",
            "抖有": "都有", "豆有": "都有",
            "不騙": "不遍", "不變": "不遍", "不便": "不遍", "不片": "不遍",
